...
public class MainState extends BasicGameState{
	...
	public static Pattern selected_pattern = null; // ausgew�hltes Pattern
	...
	public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException {
		...
		if(clicked != null){ // Clicked Pattern
			...
			if(curpatternstate == null){ // Kein Geb�ude ausgew�hlt: nur Auswahlm�glichkeit
				...
				if(clicked instanceof Wiese){ //Feld "leer" ( = Wiese)
					...
					if(curpatternstate == PatternState.WIESE) //Geb�ude entfernen (-> Wiese) 
		...
		if(delta_t >= GameSettings.DAY_MILIS){ //Ein Tag(Siehe GameSettings.DAY_MILIS) geht ver�ber
			last = 0;
